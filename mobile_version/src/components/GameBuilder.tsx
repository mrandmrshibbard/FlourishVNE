            ...
            <>
              <div style={styles.buildTypeSelector}>
                ...
                <div style={styles.buildTypes}>
                  ...
                  {/* Desktop (.exe) builds require an Electron/electron-builder
                      toolchain that cannot run inside the Android WebView, so the
                      mobile editor offers only Web + Android game exports. */}
                  {!IS_MOBILE && (
                  <button
                  ...
                  {/* Android game export needs a Gradle toolchain that can't run on
                      a phone — hidden in the mobile editor until a remote build
                      service exists. Web export works fully on-device. */}
                  {!IS_MOBILE && (
                  <button
