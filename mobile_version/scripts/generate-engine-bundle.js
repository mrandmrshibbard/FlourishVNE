...
console.log('📦 Reading game engine bundle...');

if (!fs.existsSync(enginePath)) {
  console.error('❌ Error: Game engine not found!');
...
console.log(`✓ Loaded game engine (${engineSize} KB)`);
console.log('📝 Generating gameEngineBundle.ts...');
