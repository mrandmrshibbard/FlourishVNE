...
const ResizableDraggable: React.FC<{
    ...
    useEffect(() => {
        ...
        const handleMouseMove = (e: MouseEvent) => {
            ...
            if (
                !draftRef.current ||
                draftRef.current.x !== nextRect.x ||
                draftRef.current.y !== nextRect.y ||
                draftRef.current.width !== nextRect.width ||
                draftRef.current.height !== nextRect.height
            ) {
        ...
        const handleMouseUp = () => {
            ...
            if (pendingRect) {
                requestAnimationFrame(() => setDraftRect(null));
            } else {
                setDraftRect(null);
            }
        };
    ...
    const currentRect = draftRect || { x, y, width, height };
