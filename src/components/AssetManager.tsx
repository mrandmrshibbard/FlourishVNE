            ...
            <div className="flex-1 p-3 overflow-y-auto space-y-4">
                ...
                {asset.audioUrl && onSaveReversed && (
                    <div className="bg-[var(--bg-primary)] rounded-lg p-3">
                        ...
                        <p className="text-[10px] text-[var(--text-muted)] mt-1">{t('reverseCopyHint', 'Makes a new sound in your assets that plays backwards. The copy works everywhere — including as music. This only works for WAV files.')}</p>
                    </div>
                )}
