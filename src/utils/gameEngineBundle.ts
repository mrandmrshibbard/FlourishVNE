...
export const GAME_ENGINE_BUNDLE = `var GameEngine = (function(exports, jsxRuntime2, React2, ReactDOM2) {
  ...
  const characterReducer = (state, action) => {
    ...
    switch (action.type) {
      case "ADD_CHARACTER": {
        ...
        const newId = \`char-\${generateId\$3()}\`;
        const newExprId = \`expr-\${generateId\$3()}\`;
      ...
      case "ADD_CHARACTER_LAYER": {
        ...
        const character = state.characters[characterId];
        if (!character) return state;
        const newLayerId = \`layer-\${generateId\$3()}\`;
      ...
      case "ADD_LAYER_ASSET": {
        ...
        const character = state.characters[characterId];
        if (!(character == null ? void 0 : character.layers[layerId])) return state;
        const newAssetId = \`asset-\${generateId\$3()}\`;
        const newAsset = {
          id: newAssetId,
          name,
          imageUrl,
  ...
  const sceneReducer = (state, action) => {
    switch (action.type) {
      case "ADD_SCENE": {
        const newId = \`scene-\${generateId\$2()}\`;
      ...
      case "ADD_COMMAND": {
        ...
        const newCommands = [...scene.commands, { ...command, id: \`cmd-\${generateId\$2()}\` }];
        return {
          ...state,
  ...
  const ProjectProvider = ({ children, initialProject }) => {
    const [project, dispatch] = React2.useReducer(rootReducer, initialProject);
    return /* @__PURE__ */ jsxRuntime2.jsx(ProjectContext.Provider, { value: { project, dispatch }, children });
  };
  const useProject = () => {
  ...
  const UIScreenRenderer = React2.memo(({ screenId, onAction, settings, onSettingsChange, assetResolver, gameSaves, playSound, variables = {} }) => {
            ...
            return /* @__PURE__ */ jsxRuntime2.jsx("div", { style: containerStyle, children: /* @__PURE__ */ jsxRuntime2.jsxs(
              "video",
              {
                ...
                onError: (e) => {
                  ...
                  console.error("  Error Message:", (_b = video.error) == null ? void 0 : _b.message);
  ...
  const LivePreview = ({ onClose, hideCloseButton = false, autoStartMusic = false }) => {
    ...
    React2.useEffect(() => {
      const audio = musicAudioRef.current;
      const isInMenu = (playerState == null ? void 0 : playerState.mode) !== "playing";
      if (!isInMenu) {
        if (!audio.paused) {
    ...
    React2.useEffect(() => {
      ...
      if ((playerState == null ? void 0 : playerState.mode) === "paused" && ambientInfo.policy === "continue") {
        return;
      }
  ...
  const StandalonePlayer = ({ project }) => {
    ...
    return /* @__PURE__ */ jsxRuntime2.jsx("div", { style: {
      ...
      background: "#000",
      overflow: "hidden"
    }, children: /* @__PURE__ */ jsxRuntime2.jsx(ProjectProvider, { initialProject: project, children: /* @__PURE__ */ jsxRuntime2.jsx(LivePreview, { onClose: () => {
