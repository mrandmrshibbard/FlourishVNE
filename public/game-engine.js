    ...
    return /* @__PURE__ */ jsxRuntime2.jsx(
      "div",
      {
        ...
        style: {
          ...
          ...dialogueBorderUrl ? { backgroundImage: `url(${dialogueBorderUrl})`, backgroundSize: "100% 100%", backgroundRepeat: "no-repeat", backgroundPosition: "center", padding: `${dialogueBorderPadding}px` } : {}
        },
        onClick: handleClick,
        children: /* @__PURE__ */ jsxRuntime2.jsxs(
          "div",
          {
            ...
            style: dialogueBoxUrl && !isDialogueBoxVideo ? { backgroundImage: `url(${dialogueBoxUrl})`, backgroundSize: "100% 100%", backgroundRepeat: "no-repeat", backgroundPosition: "center", ...dialogueBoxHeight ? { height: `${dialogueBoxHeight}px` } : { minHeight: "150px" }, padding: `${dialogueBoxPadding}px ${dialogueBoxPadding}px` } : { padding: `${dialogueBoxPadding}px ${dialogueBoxPadding}px`, ...dialogueBoxHeight ? { height: `${dialogueBoxHeight}px` } : { minHeight: "150px" } },
            children: [
    ...
    return /* @__PURE__ */ jsxRuntime2.jsx("div", { className: "absolute inset-0 bg-black/30 z-30 flex flex-col items-center justify-center p-8 space-y-4", children: choices.map((choice, index) => {
      ...
      return /* @__PURE__ */ jsxRuntime2.jsx(
        "div",
        {
          ...
          style: choiceBorderUrl ? { backgroundImage: `url(${choiceBorderUrl})`, backgroundSize: "100% 100%", backgroundRepeat: "no-repeat", backgroundPosition: "center", padding: `${choiceBorderPadding}px`, ...choiceWidth ? { width: `${choiceWidth}px` } : { maxWidth: "80%" }, borderRadius: "0.5rem" } : { ...choiceWidth ? { width: `${choiceWidth}px` } : { maxWidth: "80%" } },
          children: /* @__PURE__ */ jsxRuntime2.jsxs(
            "button",
            {
              ...
              style: choiceButtonUrl && !isChoiceButtonVideo ? { backgroundImage: `url(${choiceButtonUrl})`, backgroundSize: "100% 100%", backgroundRepeat: "no-repeat", backgroundPosition: "center", padding: `${choicePadding}px ${choicePadding * 2}px`, minWidth: "200px", ...choiceHeight ? { height: `${choiceHeight}px` } : {}, ...fontSettingsToStyle(projectUI.choiceTextFont), textAlign: "center", wordBreak: "break-word", overflowWrap: "break-word" } : { padding: `${choicePadding}px ${choicePadding * 2}px`, ...fontSettingsToStyle(projectUI.choiceTextFont), textAlign: "center", wordBreak: "break-word", overflowWrap: "break-word", minWidth: "200px", ...choiceHeight ? { height: `${choiceHeight}px` } : {} },
              children: [
