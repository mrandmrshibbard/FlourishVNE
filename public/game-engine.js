var GameEngine = (function(exports, jsxRuntime2, React2, ReactDOM2, reactDom) {
    ...
    switch (action.type) {
      ...
      case "DUPLICATE_SCENE": {
        ...
        const duplicatedScene = {
          ...
          commands: originalScene.commands.map((cmd) => ({ ...cmd, id: `cmd-${generateId$5()}` }))
        };
        return {
          ...state,
  ...
  const ScreenOverlayEffects = ({
    ...
    const sunbeamsBlend = ((_q = sunbeams == null ? void 0 : sunbeams.params) == null ? void 0 : _q.blendMode) || "screen";
    const shimmerBlend = ((_r = shimmer == null ? void 0 : shimmer.params) == null ? void 0 : _r.blendMode) || "overlay";
